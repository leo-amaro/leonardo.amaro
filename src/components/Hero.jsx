        ...
        <div>
            <div>
                <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">
                    <a href="/">Leonardo Amaro</a>
                </h1>
                <h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
                    Front End Developer
                </h2>
                <p className="mt-4 max-w-xs leading-normal text-slate-400">
                    I build accessible, user-centric digital experiences for the web with 8 years of expertise in modern frontend technologies.
                </p>
                ...
                <nav className="nav hidden lg:block" aria-label="In-page jump links">
                    <ul className="mt-16 w-max">
                        <li>
                            ...
                            >
                                <span className={`nav-indicator mr-4 h-px bg-slate-600 transition-all group-hover:w-16 group-hover:bg-slate-200 group-focus-visible:w-16 group-focus-visible:bg-slate-200 motion-reduce:transition-none ${
                                    activeSection === 'about' ? 'w-16 bg-slate-200' : 'w-8'
                                }`}></span>
            ...
            <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
                <li className="mr-5 text-xs shrink-0">
                    <a
                        ...
                        href="https://github.com/leonardo-amaro"
                        target="_blank"
